...
**membershipStatus** | [**UsersModelsMembershipStatusModel**](UsersModelsMembershipStatusModel.md) |  | [default to undefined]
...
```typescript
import { UsersModelsUserModel } from './api';

const instance: UsersModelsUserModel = {
    id,
    firstName,
    lastName,
    emailAddress,
